...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.334.tar.gz"
      sha256 "0bfbb55d868fb244ed74c9c79c420599c072375538cc59999092842938d4f1d0"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.334.tar.gz"
      sha256 "ff4ad305f38d830b3f855211b7fe01b0f364f69b9a4cf5398a9f99894c5fd383"
    end
  end
