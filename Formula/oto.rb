...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.320.tar.gz"
      sha256 "3a1e7d4dd200e705833ece90f8a5f4f34f9253d8857458b8d82cfeebf2bfb208"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.320.tar.gz"
      sha256 "b1ab2fcefa387dd2467dc465dd622c270084933a36acec062b8f86918bf8fda5"
    end
  end
