...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.330.tar.gz"
      sha256 "a1aff75ee8c600dce263986c93ad817ebbd9e99d00d587e2d743b3f32db2a388"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.330.tar.gz"
      sha256 "55d8833473bf13e80d197bad89389e11e4ecf35495c07f6722db7033a33ce51a"
    end
  end
