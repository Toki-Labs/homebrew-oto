...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.325.tar.gz"
      sha256 "3a234b90730eda9f36591a413f79b3947c62490f50427d3bbce429f2667ec081"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.321.tar.gz"
      sha256 "feb6bb2b354ee80fd8bdf24ea2ac57db8a3eb6f6f9675e53506597d84a55818d"
    end
  end
