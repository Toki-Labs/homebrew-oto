...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.271.tar.gz"
      sha256 "b5aba26f7320057acaf1f99282c256f21ad62c4eda14ef611db29478e8e7d53a"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.270.tar.gz"
      sha256 "8738190e0867602be4702cd83e68fbfaaf63a7fb7d0bf143e5773098a4cd2320"
    end
  end
