...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.339.tar.gz"
      sha256 "f9dfee9170d4c0e6152e58ffd3e5f8d4be568d7b25d5d8c3c4e261d75858ec35"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.339.tar.gz"
      sha256 "cfb64adff9466e27957ab18586ad79f2c7ef3ce056f29c2f6b509bc6089ac835"
    end
  end
