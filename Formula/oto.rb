...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.298.tar.gz"
      sha256 "e0917490c6cc55dce63c3ddbed4a9f501ed7c572c755bd326c8a339a8aae32c8"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.297.tar.gz"
      sha256 "c7ced4abfb7d9eda72fdba76cc4c4f8c87a536bd6b411a8c523cf903c18469e6"
    end
  end
