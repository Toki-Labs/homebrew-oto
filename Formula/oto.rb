...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.319.tar.gz"
      sha256 "3eef7dc4d822772d01a895bca47be6f7f606e896f32ce6d148de0c31d0519c74"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.318.tar.gz"
      sha256 "923dbddd001b249b44ecbaf0128e7e8ddb7a8539b414a367771b0bd05fb0c2d1"
    end
  end
