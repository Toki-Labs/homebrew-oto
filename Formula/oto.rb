...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.303.tar.gz"
      sha256 "af5eaa9e0c455854e7f0ed0651f638eadc0eef772b29cac393e6a89534e92c3e"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.302.tar.gz"
      sha256 "a0c8f868383700cbc94405f8d625eae7cfde55724682c2c0c4fbab2f62de42e4"
    end
  end
