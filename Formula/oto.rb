...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.285.tar.gz"
      sha256 "13ff36dbfd5cd80fef1b98c509d77be861584bc4ab2217def29bcf073b96066b"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.285.tar.gz"
      sha256 "0ea5fd83d40ec88322bfda82664e98034f70e5ae7971667da24754a23fca8d0e"
    end
  end
