...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.281.tar.gz"
      sha256 "f16b6dc6ce5e1a8cb3482a3cdeb2743dc14768239e76cf532474dc056c42cded"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.281.tar.gz"
      sha256 "db3a687478928c721f9f8e318354b400d64f0049310a4b0bac11962da40434d6"
    end
  end
