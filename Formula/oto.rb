...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.307.tar.gz"
      sha256 "c8b7b0457a53f9b2d2674ceaad0fe085d607e560915b640bdd0ec996e432fe3c"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.306.tar.gz"
      sha256 "9ba8b28427fedd6b8588191d2ffcecdb42fb491bb37ca6dabc92b70b51eb864d"
    end
  end
