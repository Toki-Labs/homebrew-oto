...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.283.tar.gz"
      sha256 "f38ec161f606ecaf42d6d82207c5dcb84de4a7544188314970b8d4e5de5e74bb"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.282.tar.gz"
      sha256 "2cdb11023586c4bd0f97a308939cbfa1e2184df913f135a03bb4d4ce54f43bd5"
    end
  end
