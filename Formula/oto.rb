...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.345.tar.gz"
      sha256 "b8a2f3cf4654a34a229bf9451b615f287cfd1cc9be578752f484096bf2f538f1"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.345.tar.gz"
      sha256 "1dd2754ba4b5338d05043ddfe9e7ec22fb32c1f789a6d2d165413363d23882fd"
    end
  end
