...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.329.tar.gz"
      sha256 "d12ddb1088a947d2aaa68fbf6b5a952f1b7283946adf354089fde3064b1f363a"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.325.tar.gz"
      sha256 "3e7eebead869b9bbb7b8b63be346302a4eb0bd2018f467eb3c4f40bcd00fa29b"
    end
  end
