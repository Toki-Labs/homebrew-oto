...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.272.tar.gz"
      sha256 "245b570f3b963591402d40e00550b87a2a384059a729a433f14e693516bea6a7"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.271.tar.gz"
      sha256 "12f75e3ef6bdf53f4fd8bf66a74670171bd90883a9822c79c26fd9f5d5e557cd"
    end
  end
