...
class Oto < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm? # Apple Silicon (arm64) 아키텍처인 경우
      url "https://toki-labs.com/cdn/oto/osx/oto_arm_0.0.295.tar.gz"
      sha256 "66007373e4ddadec4192c00848d795d7a51052d903893cc3967b80c163c0373c"
    ...
    if Hardware::CPU.arm? # ARM 아키텍처인 경우
      ...
      url "https://toki-labs.com/cdn/oto/linux/oto_x64_0.0.294.tar.gz"
      sha256 "702049dc6a782cff2caf857114bff35ee52ec49e69f85fe6f24db427b99b298d"
    end
  end
